...
<html lang="en">
	...
	<style>
		...
		body {
  /* Ganti URL di bawah dengan link foto kamu */
  ...
  background-size: cover;    /* Foto akan menutupi seluruh layar tanpa jadi gepeng */
  background-position: center; /* Foto tetap di tengah meskipun layar menyempit */
  background-attachment: fixed; /* Foto tidak ikut geser saat di-scroll (opsional) */
  background-repeat: no-repeat; /* Foto tidak akan muncul berulang-ulang */
